...
def validate_email(email):
    # regex duplicada do user_routes
...
def generate_id():
    # funcao que não é usada em lugar nenhum
    import uuid
    return str(uuid.uuid4())


def log_action(action, details=None):
    # log com print ao invés de logging
...
# funcao god que faz muita coisa
...
# constantes que deveriam estar em outro lugar
VALID_STATUSES = ['pending', 'in_progress', 'done', 'cancelled']
